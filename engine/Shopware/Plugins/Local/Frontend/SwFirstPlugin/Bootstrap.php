...
class Shopware_Plugins_Frontend_SwFirstPlugin_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    ...
    {
        return [
            'link' => 'http://github.com/goldscirer',
            'author' => 'Seweryn Wawrzynowicz',
